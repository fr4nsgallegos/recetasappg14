          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                cursorWidth: 20, //ancho del cursor
                cursorHeight: 40, //alto del cursor
                cursorRadius: Radius.circular(
                  2,
                ), //border redondeados en el cursos
                maxLines: 2, //máximo de lineas en el textfield
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderSide: BorderSide(color: Colors.red, width: 16),
